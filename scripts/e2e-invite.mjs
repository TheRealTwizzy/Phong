...
await host.waitForSelector('#building-pvp', { timeout: 15000 });
...
await home.waitForSelector('#building-pvp', { timeout: 15000 });
...
await host2.waitForSelector('#building-pvp', { timeout: 15000 });
