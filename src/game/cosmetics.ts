...
const DEFS: Record<CosmeticId, CosmeticDef> = {
  ...
  // Authored in the regions the DISTINCT floor still had room in: light mode,
  // which had one entry, and desaturated green/teal. The amber-gold and
  // blue-violet bands are full — the closest existing pair sits 0.003 over
  // the 0.08 floor — so a new warm or violet entry fails the suite on arrival,
  // however different it looks in a swatch.
  'event-horizon': {
    id: 'event-horizon',
    nameKey: 'cosmetic_event-horizon',
    mode: 'dark',
    background: '#020806',
    courtColor: '#04110d',
    courtBorder: '#0d9488',
    netLineColor: '#2dd4bf',
    netGlowColor: 'rgba(45, 212, 191, 0.7)',
    playerPaddleColor: '#2dd4bf',
    playerPaddleGlow: '#2dd4bf',
    opponentPaddleColor: '#0f766e',
    opponentPaddleGlow: '#0f766e',
    ballColor: '#ecfeff',
    ballGlow: '#2dd4bf',
    ...
    scanlines: true,
    unlockRequirement: {
      eliteMissionId: 'elite_chaos_3',
    },
  },
  glasshouse: {
    id: 'glasshouse',
    nameKey: 'cosmetic_glasshouse',
    mode: 'light',
    background: '#e6f0e8',
    courtColor: '#f3f8f4',
    courtBorder: '#86b098',
    netLineColor: '#166534',
    netGlowColor: 'rgba(22, 101, 52, 0.35)',
    playerPaddleColor: '#0b7a4b',
    playerPaddleGlow: 'rgba(11, 122, 75, 0.35)',
    opponentPaddleColor: '#c2410c',
    opponentPaddleGlow: 'rgba(194, 65, 12, 0.3)',
    ballColor: '#14532d',
    ballGlow: 'rgba(20, 83, 45, 0.4)',
    trailColor: 'rgba(11, 122, 75, 0.25)',
    gridColor: 'rgba(22, 101, 52, 0.06)',
    accentColor: '#0f766e',
    scanlines: false,
    unlockRequirement: {
      eliteMissionId: 'elite_rally_60',
    },
  },
  floodlights: {
    id: 'floodlights',
    nameKey: 'cosmetic_floodlights',
    mode: 'light',
    background: '#f6f1e7',
    courtColor: '#fcf9f2',
    courtBorder: '#c9b99a',
    netLineColor: '#1e3a8a',
    netGlowColor: 'rgba(30, 58, 138, 0.35)',
    playerPaddleColor: '#b91c1c',
    playerPaddleGlow: 'rgba(185, 28, 28, 0.35)',
    opponentPaddleColor: '#9a3412',
    opponentPaddleGlow: 'rgba(154, 52, 18, 0.3)',
    ballColor: '#1c1917',
    ballGlow: 'rgba(28, 25, 23, 0.4)',
    trailColor: 'rgba(185, 28, 28, 0.25)',
    gridColor: 'rgba(30, 58, 138, 0.06)',
    accentColor: '#1e3a8a',
    scanlines: false,
    unlockRequirement: {
      eliteMissionId: 'elite_duel_5',
    },
  },
  'moss-court': {
    id: 'moss-court',
    nameKey: 'cosmetic_moss-court',
    mode: 'dark',
    // Grey-green rather than sage-and-bone: the first draft's pale sage paddle
    // and bone ball read as gilded-age's gold and cream in OKLab (0.067 mean,
    // under the floor), however different they looked in a swatch.
    background: '#1c211c',
    courtColor: '#28302a',
    courtBorder: '#6f8f5a',
    netLineColor: '#9ccc65',
    netGlowColor: 'rgba(156, 204, 101, 0.5)',
    playerPaddleColor: '#9ccc65',
    playerPaddleGlow: '#9ccc65',
    opponentPaddleColor: '#8d99ae',
    opponentPaddleGlow: '#8d99ae',
    ballColor: '#f5f5f5',
    ballGlow: '#9ccc65',
    trailColor: 'rgba(156, 204, 101, 0.3)',
    gridColor: 'rgba(111, 143, 90, 0.12)',
    accentColor: '#7cb342',
    scanlines: false,
    unlockRequirement: {
      eliteMissionId: 'elite_shutout_5',
    },
  },
  'overlord-chrome': {
    id: 'overlord-chrome',
    nameKey: 'cosmetic_overlord-chrome',
    mode: 'light',
    background: '#dfe3e8',
    courtColor: '#eef1f4',
    courtBorder: '#9aa3ad',
    netLineColor: '#111827',
    netGlowColor: 'rgba(17, 24, 39, 0.35)',
    playerPaddleColor: '#111827',
    playerPaddleGlow: 'rgba(17, 24, 39, 0.35)',
    opponentPaddleColor: '#7c3aed',
    opponentPaddleGlow: 'rgba(124, 58, 237, 0.3)',
    ballColor: '#b91c1c',
    ballGlow: 'rgba(185, 28, 28, 0.4)',
    trailColor: 'rgba(17, 24, 39, 0.25)',
    gridColor: 'rgba(17, 24, 39, 0.06)',
    accentColor: '#1f2937',
    scanlines: false,
    unlockRequirement: {
      achievementId: 'tier_overlord',
      minTier: 'overlord',
    },
  },
};
