...
export const ALL_ACHIEVEMENTS: Achievement[] = [
  ...
  {
    id: 'veteran_500',
    title: 'Five Hundred Nights',
    description: 'Complete 500 total matches.',
    branch: 'foundation',
    parent: 'veteran_200',
    category: 'special',
    xpReward: 700,
  ...
  {
    id: 'veteran_1000',
    title: 'Thousand-Match Club',
    description: 'Complete 1,000 total matches.',
    branch: 'foundation',
    parent: 'veteran_500',
    category: 'special',
    xpReward: 1100,
  ...
  },
  {
    id: 'rally_200',
    title: 'Metronome',
    description: 'Sustain a streak of 144 returns. Needs level 20.',
    branch: 'rally',
    parent: 'rally_150',
    category: 'mastery',
    xpReward: 1200,
  ...
  {
    id: 'rally_300',
    title: 'Perpetual Machine',
    description: 'Sustain a streak of 216 returns. Needs level 25.',
    branch: 'rally',
    parent: 'rally_200',
    category: 'mastery',
    xpReward: 1500,
  ...
  },
  {
    ...
    description: 'Return 500 in a row on the Practice Wall.',
    branch: 'rally',
    parent: 'wall_200',
    category: 'mastery',
    xpReward: 800,
  ...
  },
  {
    id: 'cyber_25',
    title: 'Scrap Yard',
    description: 'Beat the Cyber AI 25 times.',
    branch: 'ladder',
    parent: 'cyber_10',
    category: 'mastery',
    xpReward: 1100,
  ...
  // The Chaos clean sheet is a sibling feat beside the top of the ladder,
  // exactly the shape cyber_shutout has one rung down: nothing hangs off it.
  {
    id: 'chaos_shutout',
    title: 'Silent Storm',
    description: 'Hold the Chaos AI on zero in a first-to-5 match or longer.',
    branch: 'ladder',
    parent: 'ai_chaos',
    category: 'mastery',
    xpReward: 1100,
  ...
  },
  {
    id: 'chaos_25',
    title: 'Storm Warden',
    description: 'Beat the Chaos AI 25 times. Needs level 25.',
    branch: 'ladder',
    parent: 'chaos_10',
    category: 'mastery',
    xpReward: 1300,
  ...
  },
  {
    id: 'chaos_50',
    title: 'Chaos Ender',
    description: 'Beat the Chaos AI 50 times.',
    branch: 'ladder',
    parent: 'chaos_25',
    category: 'mastery',
    xpReward: 1600,
  ...
  // Re-parented onto duel_25 when that rung was added between them. Safe under
  // the strict-parent rule because an earned id is never revoked: a player
  // already holding this keeps it, and duel_25 back-fills on their next match.
  {
    id: 'duel_50',
    title: 'Fixture',
  ...
  },
  {
    id: 'duel_100',
    title: 'Hundred Duels',
    description: 'Win 100 duels. Needs Master tier or above.',
    branch: 'duel',
    parent: 'duel_50',
    category: 'online',
    xpReward: 1100,
  ...
  },
  {
    id: 'ace_250',
    title: 'Marksman',
    description: 'Score 250 career aces.',
    branch: 'craft',
    parent: 'ace_100',
    category: 'mastery',
    xpReward: 900,
  ...
  },
  {
    id: 'points_5000',
    title: 'Five Thousand',
    description: 'Score 5,000 career points.',
    branch: 'craft',
    parent: 'points_2000',
    category: 'special',
    xpReward: 1200,
  ...
  },
  {
    id: 'points_10000',
    title: 'Ten Thousand',
    description: 'Score 10,000 career points.',
    branch: 'craft',
    parent: 'points_5000',
    category: 'special',
    xpReward: 1600,
  ...
  // The apex asks for OVERLORD_MIN_DUELS ranked duels beyond its rating (see
  // rating.ts), and this is where that requirement is stated as a thing to work
  // toward — visible, not hidden, because a requirement nobody can read is a
  // wall rather than a rung.
  {
    id: 'duels_25',
    title: 'Tested',
    description: 'Play 25 ranked duels. What Cyber Overlord asks for beyond the rating.',
    branch: 'ascent',
    parent: 'placed',
    category: 'online',
    xpReward: 500,
  ...
  },
  {
    id: 'duels_100',
    title: 'Hardened',
    description: 'Play 100 ranked duels.',
    branch: 'ascent',
    parent: 'duels_25',
    category: 'online',
    xpReward: 1200,
  ...
  },
  {
    id: 'streak_20',
    title: 'Unstoppable',
    description: 'Win 20 matches in a row. Needs level 20.',
    branch: 'dominion',
    parent: 'streak_10',
    category: 'special',
    xpReward: 900,
  ...
  },
  {
    id: 'streak_30',
    title: 'Juggernaut',
    description: 'Win 30 matches in a row.',
    branch: 'dominion',
    parent: 'streak_20',
    category: 'special',
    xpReward: 1300,
  ...
  },
  {
    id: 'shutout_50',
    title: 'Vault',
    description: 'Win 50 matches of first-to-5 or longer with your opponent on zero.',
    branch: 'dominion',
    parent: 'shutout_15',
    category: 'special',
    xpReward: 1100,
